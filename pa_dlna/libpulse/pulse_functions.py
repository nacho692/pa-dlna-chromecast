...
pulse_functions = \
{'callbacks': {'pa_autoload_info_cb_t': ('void',
                                         ['pa_context *',
                                          'pa_autoload_info *',
                                          'int',
                                          'void *']),
               ...
               'pa_time_event_destroy_cb_t': ('void',
                                              ['pa_mainloop_api *',
                                               'pa_time_event *',
                                               'void *'])},
 'signatures': {'PA_CONTEXT_IS_GOOD': ('int', ['pa_context_state_t']),
                'PA_SINK_IS_OPENED': ('int', ['pa_sink_state_t']),
                'PA_SINK_IS_RUNNING': ('int', ['pa_sink_state_t']),
                'PA_SOURCE_IS_OPENED': ('int', ['pa_source_state_t']),
                'PA_SOURCE_IS_RUNNING': ('int', ['pa_source_state_t']),
                'PA_STREAM_IS_GOOD': ('int', ['pa_stream_state_t']),
                'atfork': ('void', ['void']),
                'defer_enable': ('void', ['pa_defer_event *', 'int']),
